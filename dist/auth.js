...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.authState.error = (error === null || error === void 0 ? void 0 : error.message) || null;
                        return [2 /*return*/, { user: data.user, error: error }];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        err_1 = _b.sent();
                        console.error('Error in getCurrentUser:', err_1);
    ...
    AuthService.prototype.getAuthState = function () {
        return __assign({}, this.authState);
    };
...
export { AuthService };
export var authService = AuthService.getInstance();
